<x-layout>
    <x-slot:nav-title>
        <strong>Classroom Trashed</strong>
    </x-slot:nav-title>
        ...
        <div class="container">
            <div class="cards">
                @foreach ($classrooms as $i => $classroom)
                    <x-card :classroom="$classroom" :index="$i" type='trashed classroom' />
                @endforeach
            </div>
        </div>
    @else
        <div>
            <div class="icon" style="margin-top:144px; width:100%;">
                <svg xmlns="http://www.w3.org/2000/svg" style="width: 100%" width="187" height="219" viewBox="0 0 187 219" fill="none">
                    <path
                        d="M171.921 112.679C173.1 112.174 174.446 111.922 175.877 111.922C181.43 111.922 185.975 116.466 185.975 122.02C185.975 127.574 181.43 132.118 175.877 132.118C174.698 132.118 173.604 131.95 172.51 131.529"
                        stroke="#5F6368" stroke-width="2" stroke-miterlimit="10" />
                    <path d="M71.1079 96.7744C71.4445 96.7744 76.0167 100.14 78.2608 101.824" stroke="#5F6368"
                    ...
                    <path
                        ...
                        fill="#DADCE0" />
                    <path d="M50.4067 126.227H156.438" stroke="#5F6368" stroke-width="2" stroke-miterlimit="10" />
                    <path d="M50.4067 74.0527H156.438" stroke="#5F6368" stroke-width="2" stroke-miterlimit="10" />
                    <path d="M29.4531 185.554L79.5232 208.275M85.8346 204.488L142.216 168.303" stroke="#5F6368"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <path
                        ...
                        stroke="#5F6368" stroke-width="2" />
                    <path
                        d="M15.4837 114.11C16.4094 113.016 17.3351 111.838 18.5973 111.249C19.8596 110.659 21.6268 110.744 22.4683 111.753C23.7306 113.268 22.5525 115.709 20.7853 116.55C19.0181 117.392 16.9143 117.055 15.063 116.718"
                        stroke="#5F6368" stroke-width="2" />
                    <path
                        d="M5.04938 139.103C6.64826 139.103 6.64826 136.578 5.04938 136.578C3.36635 136.578 3.36635 139.103 5.04938 139.103Z"
                        fill="#5F6368" />
                    <path
                        d="M6.81635 145.834C8.41522 145.834 8.41522 143.31 6.81635 143.31C5.21747 143.31 5.21747 145.834 6.81635 145.834Z"
                        fill="#5F6368" />
                    <path
                        d="M11.3603 141.963C12.9592 141.963 12.9592 139.438 11.3603 139.438C9.76141 139.438 9.76141 141.963 11.3603 141.963Z"
                        fill="#5F6368" />
                    <path
                        d="M14.8105 148.107C16.4094 148.107 16.4094 145.582 14.8105 145.582C13.2116 145.582 13.2116 148.107 14.8105 148.107Z"
                        fill="#5F6368" />
                    <path
                        d="M10.0981 149.789C11.697 149.789 11.697 147.265 10.0981 147.265C8.49921 147.265 8.49921 149.789 10.0981 149.789Z"
                        fill="#5F6368" />
                    <path
                    ...
                    <path
                        ...
                        fill="#5F6368" />
                    <path
                        d="M153.913 106.03C164.137 106.03 172.426 104.147 172.426 101.823C172.426 99.499 164.137 97.6152 153.913 97.6152C143.688 97.6152 135.399 99.499 135.399 101.823C135.399 104.147 143.688 106.03 153.913 106.03Z"
                        fill="white" stroke="#5F6368" stroke-width="2" stroke-miterlimit="10" />
                    <path d="M171.08 104.684L134.138 126.648V101.402L142.553 105.61L159.804 105.862L171.08 104.684Z"
                        fill="#5F6368" />
                    <path d="M81.543 201.963L29.3691 181.767L89.9582 147.265L142.132 163.253L81.543 201.963Z"
                        fill="#9AA0A6" />
                    <path
                    ...
                    <path
                        ...
                        fill="#5F6368" />
                    <path d="M14.3057 106.872L15.9887 124.123" stroke="#5F6368" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </div>
            <h4 style="    text-align: center;
            color: #666;
            margin-top: 25px;">None of your classes have been archived</h4>
        </div>
    @endif
