    ...
    <section class="show-classwork container">
        <div class="left">
            <div class="header">
                ...
                <div class="points">
                    <div class="point-number">{{ $classwork->options['points'] ?? 'unmarked' }} points</div>
        ...
        <div class="right">
            ...
            <div class="private-comment">
                ...
                <span>Add Comment To <span style="text-transform: capitalize;"> {{ $classroom->user->name }}</span></span>
            </div>
        </div>
    </section>
</x-layout>
